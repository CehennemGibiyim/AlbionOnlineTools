...
const ITEMS = {
    ...
    PORK_OMELETTE: 'T7_MEAL_OMELETTE%401',
    BEEF_STEW: 'T8_MEAL_STEW%401',
    BREAD: 'T8_MEAL_SANDWICH%401',
    ROAST_PORK: 'T8_MEAL_ROASTPORK%401',
    PIE: 'T8_MEAL_PIE%401',
    SALAD: 'T8_MEAL_SALAD%401',

    // Potions — verified Albion render API IDs
    MAJOR_HEALING: 'T6_POTION_HEAL%401',
    MAJOR_RESISTANCE: 'T8_POTION_STONESKIN%401',
    ENERGY_POTION: 'T8_POTION_ENERGY%401',
    GIANT_STRENGTH: 'T8_POTION_GIGANTIFY%401',
    INVISIBILITY: 'T8_POTION_INVISIBILITY%401',
    CLEANSE: 'T8_POTION_CLEANSE%401',
};
